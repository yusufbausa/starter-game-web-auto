...
WebUI.click(findTestObject('Object Repository/Create Player/dropdown_select_persona_default'))
WebUI.setText(findTestObject('Object Repository/Create Player/field_nickname'), nicknamePlayer)
...
if (verifyPlayer == true) {
	KeywordUtil.markPassed("Test Case Passed : Player not created as expected")
} else {
	KeywordUtil.markFailed("Test Failed : Player created with empty name")
}
