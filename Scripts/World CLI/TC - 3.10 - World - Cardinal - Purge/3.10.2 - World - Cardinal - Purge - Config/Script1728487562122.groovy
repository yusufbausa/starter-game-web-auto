...
Windows.sendKeys(findWindowsObject('Object Repository/Terminal Test/TextArea'), Keys.chord('world cardinal purge --config=/mnt/c/Users/yusuf/starter-game/world.toml', Keys.ENTER))
...
String worldCardinalPurgeSS = RunConfiguration.getProjectDir() + '/Terminal Screenshot/[3.10.2] World Cardinal Purge Config.png'
