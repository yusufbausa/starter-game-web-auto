...
def jsonResponse = WebUI.getText(findTestObject('Object Repository/Query Player/Query Health Player/json_response_health_error'))
def popUpResponse = WebUI.getText(findTestObject('Object Repository/Query Player/Query Health Player/error_popUp_header'))
