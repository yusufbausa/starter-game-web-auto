...
Windows.sendKeys(findWindowsObject('Object Repository/Terminal Test/TextArea'), Keys.chord('world evm start --dev', Keys.ENTER))
Windows.delay(30)

def worldEvmStartDevActual = Windows.getText(findWindowsObject('Object Repository/Terminal Test/TextArea'))
String worldEvmStartDev = '"message":"indexed block events"'

String worldEvmStartDevSS = RunConfiguration.getProjectDir() + '/Terminal Screenshot/[3.12.6] World EVM Start Dev.png'
