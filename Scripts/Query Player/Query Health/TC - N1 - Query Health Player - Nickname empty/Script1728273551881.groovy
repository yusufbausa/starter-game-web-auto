...
def hpResponse = findTestObject('Object Repository/Query Player/Query Health Player/json_response_health')
boolean verifyPlayer = WebUI.verifyElementNotPresent(hpResponse, 5)
