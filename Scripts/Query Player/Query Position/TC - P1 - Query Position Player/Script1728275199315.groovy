...
def positionResponse = WebUI.getText(findTestObject('Object Repository/Query Position Player/query_response'))

KeywordLogger log = new KeywordLogger()

if (positionResponse.contains('"Position":')) {
	log.logInfo("Position Response = " + positionResponse)
