...
//====================================================================================================================================================
//[3.2.4] world completion powershell
//====================================================================================================================================================
Windows.sendKeys(findWindowsObject('Object Repository/Terminal Test/TextArea'), Keys.chord('world completion powershell', Keys.ENTER))
Windows.delay(1)

def worldCompletionPowershellActual = Windows.getText(findWindowsObject('Object Repository/Terminal Test/TextArea'))
String worldCompletionPowershell = 'powershell completion for world'

String worldCompletionPowershellSS = RunConfiguration.getProjectDir() + '/Terminal Screenshot/[3.2.4] World Completion Powershell.png'
